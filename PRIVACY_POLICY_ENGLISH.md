...
- Package names and application names of monitored apps
- Application icons (for UI display purposes)

**Purpose:** This information is collected to enable you to select which applications to monitor for network traffic debugging.
...
- **App Selection:** Display installed applications for monitoring selection
...
- **Personalized Ads:** Display relevant advertisements based on your interests
...
1. Using this app for any illegal activities such as malicious attacks on network data, creating plugins, or stealing data
2. Debugging and modifying network data of other hosts, IPs, and apps without official authorization
3. Reverse engineering this app (including decompiling, modifying installation packages, or signature information)
4. Distributing unauthorized versions of this app

### Disclaimer
We are not liable for any damages resulting from:
1. Violations of this agreement or related service terms
2. Third-party damages caused by your violations
3. Service interruptions due to force majeure events
4. System interruptions due to technical issues or government orders

### Risk Acknowledgment
You acknowledge that:
1. Cache generated during app operation may contain sensitive information (passwords, cookies, etc.)
2. You should clean up data regularly or close the app during sensitive operations
3. You must comply with local laws regarding network analysis tools

## Contact Us

If you have any questions about this Privacy Policy or our data practices, please contact us at:

**Email:** zhuxiaoit3@gmail.com  
**App Name:** HTTP Sniffer  
**Developer:** HTTP Sniffer Development Team
